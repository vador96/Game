...
public class Monster extends Character {
	...
	private void lookForPlayer(Game game) {
        // It is the AI of the monster with two modes:
        // patrol if the target is out of view
        // huntTarget otherwise
	...
	private void patrol() {
        // random patrolling of the monster
	...
	private void huntTarget(Player target) {
        // if the monster sees the target, he will purchase him
        // by going to the target's position (target means player)
