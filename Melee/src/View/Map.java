		...
		if (Game.state == GameState.Running) {
			...
			if (mapMatrix == null) {
				...
				for (int i = 0; i < monsters.size(); i++) {
                    ...
                    int xf = (int) monsters.get(i).fieldOfAction.getX();
                    int yf = (int) monsters.get(i).fieldOfAction.getY();
                    int w = (int) monsters.get(i).fieldOfAction.getWidth();
                    int h = (int) monsters.get(i).fieldOfAction.getHeight();
                    g.drawRect(xf, yf, w, h);
