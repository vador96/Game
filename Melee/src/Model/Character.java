...
public abstract class Character implements Collidable, Collision, Subject, Runnable {
    ...
    public Rectangle fieldOfAction;
	...
	public void generateHitbox() {
        ...
        this.fieldOfAction = new Rectangle(this.posX, this.posY + sizeSquare, sizeSquare, sizeSquare);
	}
    ...
    public void setFieldOfAction() {
        if(dir == 0) {
            this.fieldOfAction.setBounds(posX - sizeSquare/4, posY, sizeSquare/4, sizeSquare);
        } else if (dir == 2) {
            this.fieldOfAction.setBounds(posX + sizeSquare, posY, sizeSquare/4, sizeSquare);
        } else if (dir == 1) {
            this.fieldOfAction.setBounds(posX, posY - sizeSquare/4, sizeSquare, sizeSquare/4);
        } else if (dir == 3) {
            this.fieldOfAction.setBounds(posX, posY + sizeSquare, sizeSquare, sizeSquare/4);
        }
    }
